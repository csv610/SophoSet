...
def process_dataset():
    ...
    for split in SPLITS:
        ...
        subset_data = process_subset(split, llm)
...
if __name__ == "__main__":
    logger.info("Starting GSM-Plus benchmark process")
    process_dataset()
    logger.info("GSM-Plus benchmark process completed")
