...
class MedicalQuestions_Query(ModelQueryBase):
    def __init__(self, model_name):
        self.dataset_name = "fhirfly/medicalquestions"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process Medical Question dataset")
    ...
    eval = MedicalQuestions_Query(model_name=args.model_name)
