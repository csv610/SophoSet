...
def main():
    ...
    model_name = st.selectbox("Select model:", ["llama3.2-vision", "llava", "bakllava", "llava-phi3", "minicpm-v"
])
    llm = LlavaModel(model_name)
    ...
    user_question = st.text_input("Ask question", "What's in this image?")
