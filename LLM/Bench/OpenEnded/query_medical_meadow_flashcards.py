...
class MedicalMeadowFlashCards_Query(ModelQueryBase):
    def __init__(self, model_name):
        self.dataset_name = "medalpaca/medical_meadow_medical_flashcards"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process Medical Meadow Flash Cards dataset")
    ...
    eval = MedicalMeadowFlashCards_Query(model_name=args.model_name)
