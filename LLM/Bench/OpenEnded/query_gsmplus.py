...
class GSMPlus_Query(ModelQueryBase):
    def __init__(self, model_name):
        self.dataset_name = "qintongli/GSM-Plus"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process GSMPlus dataset")
    ...
    eval = GSMPlus_Query(model_name=args.model_name)
